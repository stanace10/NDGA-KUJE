...
def build_public_admission_snapshot(submission: PublicSiteSubmission):
    ...
    record = {
        ...
        "declaration": {
            ...
            "parent_guardian_signature_image": _clean(declaration.get("parent_guardian_signature_image")),
            ...
            "student_signature_image": _clean(declaration.get("student_signature_image")),
        ...
        "documents": [
            ...
            {
                "label": "Admission Payment Receipt",
                "name": _stored_file_name(_field_file_name(getattr(submission, "application_fee_receipt", None))) or _clean(
                    documents.get("application_fee_receipt_name")
                ),
                "url": _field_file_url(getattr(submission, "application_fee_receipt", None)),
            },
        ],
        "payment": {
