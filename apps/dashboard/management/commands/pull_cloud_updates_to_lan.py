...
class Command(BaseCommand):
    help = (
        "Pull cloud-originated admission registration updates "
    ...
    def handle(self, *args, **options):
        ...
        try:
            self.stdout.write("Pulling cloud admission registrations into LAN...")
        ...
        self.stdout.write(
            self.style.SUCCESS(
                "LAN is now updated with the latest cloud admission records. Finance records are LAN-authored and pushed to cloud only."
            )
        )
