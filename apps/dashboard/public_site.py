...
class PublicHomeView(PublicWebsiteBaseView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["hero"] = {"eyebrow": DISPLAY_SCHOOL_NAME, "title": "A Catholic girls' secondary boarding school in Kuje, Abuja.", "text": "Learning, boarding, faith, and student care come together in one clear school experience for girls.", "video": SITE_VIDEOS["hero"], "poster": SITE_IMAGES["hero"], "actions": [{"label": "Apply for Admission", "url": self.page_url("registration"), "variant": "primary"}, {"label": "Explore School Life", "url": self.page_url("school-life"), "variant": "secondary"}, {"label": "School Portal", "url": self.page_url("portal"), "variant": "ghost"}], "highlights": ["Girls' boarding school", "Junior and senior secondary", "Catholic learning tradition"]}
        context["hero_side"] = {"title": "What families need first", "items": [{"label": "Admissions", "value": "Registration, fees, documents, and next steps"}, {"label": "Boarding", "value": "Hostel life, routines, welfare, and supervision"}, {"label": "Contact", "value": f"{PRIMARY_PHONE}  |  {SECONDARY_PHONE}"}]}
        context["about_preview"] = {"eyebrow": "About NDGA", "title": "Learning, discipline, faith, and care held together in one school community.", "text": "Notre Dame Girls' Academy serves girls through serious teaching, Catholic formation, boarding structure, and close daily guidance.", "image": SITE_IMAGES["campus"], "bullets": ["A boarding rhythm that protects study time", "Faith-rooted formation and good conduct", "A school environment families can trust"], "actions": [{"label": "About NDGA", "url": self.page_url("about"), "variant": "primary"}, {"label": "Principal's Welcome", "url": self.page_url("principal"), "variant": "secondary"}]}
        context["principal_preview"] = {"eyebrow": "Principal's Welcome", "title": "Academic seriousness and student care are expected to stand together.", "message": "Girls are guided with structure, encouraged with care, and taught to take study, conduct, and responsibility seriously from the start.", "name": context["principal_name"], "url": self.page_url("principal"), "image": SITE_IMAGES["principal"]}
        context["why_choose"] = [{"title": "Academic focus", "text": "Girls are taught with clear expectations for study, revision, and class participation."}, {"title": "Structured boarding", "text": "Hostel life supports routine, supervision, rest, and steady academic follow-up."}, {"title": "Faith and character", "text": "Catholic formation helps shape respect, responsibility, and service."}, {"title": "Safe environment", "text": "School life is organised with welfare, order, and student visibility in view."}, {"title": "Guided teachers", "text": "Learning is supported by close follow-up and purposeful classroom leadership."}, {"title": "Balanced development", "text": "Girls grow through academics, clubs, arts, sports, and community life."}]
        context["academic_preview"] = [{"title": "Junior Secondary", "text": "Strong foundations in literacy, numeracy, science, and disciplined study habits.", "image": SITE_IMAGES["school_life"], "url": self.page_url("junior-secondary")}, {"title": "Senior Secondary", "text": "Focused subject learning, examination readiness, and stronger personal responsibility.", "image": SITE_IMAGES["students"], "url": self.page_url("senior-secondary")}, {"title": "Curriculum", "text": "Subject groups are arranged clearly so families can see the shape of learning at NDGA.", "image": SITE_IMAGES["campus"], "url": self.page_url("curriculum")}, {"title": "ICT & Digital Learning", "text": "Practical digital skills that support research, classwork, and CBT readiness.", "image": SITE_IMAGES["students"], "url": self.page_url("ict-digital-learning")}, {"title": "Clubs & Activities", "text": "Co-curricular life builds confidence, teamwork, and balanced student growth.", "image": SITE_IMAGES["school_life"], "url": self.page_url("clubs-co-curriculars")}]
        context["admissions_steps"] = ["Register online and choose the intended class.", "Review the approved fee areas and prepare payment.", "Wait for screening, class-placement guidance, or document follow-up.", "Receive the school's review outcome and next admission instruction."]
        context["fees_preview"] = [{"title": "School Fees", "text": "Review the main school charge areas before registration.", "url": self.page_url("fees")}, {"title": "Hostel / Boarding", "text": "See how boarding fits into the admissions and fee plan.", "url": self.page_url("hostel")}, {"title": "Other Charges", "text": "Application and related approved charges stay visible.", "url": self.page_url("fees")}, {"title": "Payment Information", "text": "Families receive the right payment instruction before transfer.", "url": self.page_url("fees")}]
        ...
        context["credibility_preview"] = [{"title": "Parent clarity", "text": "Admissions, fees, boarding, and contact routes are visible without guesswork."}, {"title": "Student support", "text": "Girls are taught, supervised, and followed up closely across school and hostel life."}, {"title": "Faith formation", "text": "Catholic identity shapes the tone of learning, conduct, and service."}, {"title": "Academic preparation", "text": "Girls are prepared for examinations and the next stage through steady classroom discipline."}]
        context["final_cta"] = {"title": "Move from enquiry to registration with the right information in front of you.", "links": [{"label": "Apply for Admission", "url": self.page_url("registration"), "variant": "primary"}, {"label": "View Fees", "url": self.page_url("fees"), "variant": "secondary"}, {"label": "Contact Admissions", "url": self.page_url("contact"), "variant": "secondary"}, {"label": "School Portal", "url": self.page_url("portal"), "variant": "ghost"}]}
        return context
