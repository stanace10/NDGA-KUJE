...
def build_portal_navigation(*, portal_key: str, role_codes: set[str], request_path: str, setup_is_ready: bool):
    ...
    if portal_key == "it":
        ...
        if cloud_staff_admin_restricted:
            items.extend(
                [
                    _nav_item(label="Command Center", url="/portal/it/", request_path=request_path, matches=("/", "/portal/it/$"), section="Overview"),
                    _nav_item(label="Admissions", url="/portal/it/admissions/", request_path=request_path, matches=("/portal/it/admissions/",), section="Admissions"),
                    _nav_item(label="Transcript Requests", url="/portal/it/transcripts/", request_path=request_path, matches=("/portal/it/transcripts/", "/portal/transcripts/"), section="Admissions"),
                    _nav_item(label="Public Website", url="/portal/it/public-website/", request_path=request_path, matches=("/portal/it/public-website/",), section="System"),
                    _nav_item(label="Notifications", url="/notifications/center/", request_path=request_path, matches=("/notifications/",), section="System"),
                    _nav_item(label="Audit Logs", url="/audit/events/", request_path=request_path, matches=("/audit/events/",), section="System"),
                    _nav_item(label="Account Security", url="/portal/account/security/", request_path=request_path, matches=("/portal/account/security/",), section="System"),
                    _nav_item(label="Logout", url="/auth/logout/", request_path=request_path, matches=("/auth/logout/",), section="System"),
                ]
            )
            return items
        cbt_children = [
            _nav_item(label="Exam Control Board", url="/cbt/it/activation/", request_path=request_path, matches=("/cbt/it/activation/",)),
            _nav_item(label="Paper Import & AI Scan", url="/cbt/authoring/upload/", request_path=request_path, matches=("/cbt/authoring/upload/",)),
            _nav_item(label="CBT Monitoring", url="/cbt/it/lockdown/", request_path=request_path, matches=("/cbt/it/lockdown/",)),
            _nav_item(label="JAMB Administration", url="/cbt/it/jamb/", request_path=request_path, matches=("/cbt/it/jamb/",)),
            _nav_item(label="Emergency Control", url="/cbt/it/emergency/", request_path=request_path, matches=("/cbt/it/emergency/",)),
            _nav_item(label="Simulation Registry", url="/cbt/it/simulations/", request_path=request_path, matches=("/cbt/it/simulations/",)),
        ]
        items.extend(
            [
                _nav_item(label="Command Center", url="/portal/it/", request_path=request_path, matches=("/", "/portal/it/$"), section="Overview"),
        ...
        if not lan_runtime_restricted:
            items.extend(
                [
                    _nav_item(label="Academic Setup", url="/portal/it/academic-setup/", request_path=request_path, matches=("/portal/it/academic-setup/",), section="Academics"),
                    _nav_item(label="Staff Management", url="/auth/it/user-provisioning/staff/directory/", request_path=request_path, matches=("/auth/it/user-provisioning/staff/", "/auth/it/staff/"), section="Academics"),
                    _nav_item(label="Student Management", url="/auth/it/user-provisioning/students/directory/", request_path=request_path, matches=("/auth/it/user-provisioning/students/", "/auth/it/student/"), section="Academics"),
                    _nav_item(label="Result Management", url="/results/approval/", request_path=request_path, matches=("/results/approval/",), section="Academics"),
                    _nav_item(label="Publish Results", url="/results/report/send-results/", request_path=request_path, matches=("/results/report/send-results/", "/results/report/access-pins/"), section="Academics"),
                    _nav_item(label="Academic Performance", url="/results/report/academic-performance/", request_path=request_path, matches=("/results/report/academic-performance/", "/results/report/ca-performance/", "/results/management/ca1/"), section="Academics"),
                    _nav_item(label="Performance Reports", url="/results/report/performance/", request_path=request_path, matches=("/results/report/",), section="Academics"),
                ]
            )
        else:
            items.append(_nav_item(label="Academic Setup", url="/portal/it/academic-setup/", request_path=request_path, matches=("/portal/it/academic-setup/",), section="Academics"))
        items.extend(
            [
                _nav_item(label="CBT Operations", url="/cbt/it/activation/", request_path=request_path, matches=(), section="CBT Operations", children=cbt_children),
                _nav_item(label="Messaging Center", url="/notifications/media/", request_path=request_path, matches=("/notifications/media/",), section="System"),
                _nav_item(label="Notifications", url="/notifications/center/", request_path=request_path, matches=("/notifications/center/",), section="System"),
                _nav_item(label="Public Website", url="/portal/it/public-website/", request_path=request_path, matches=("/portal/it/public-website/",), section="System"),
                _nav_item(label="Session & Term Control", url=settings_url, request_path=request_path, matches=("/setup/", "/attendance/calendar/"), section="System"),
                _nav_item(label="School Settings", url="/results/settings/", request_path=request_path, matches=("/results/settings/",), section="System"),
                _nav_item(label="Election Setup", url="/elections/it/manage/", request_path=request_path, matches=("/elections/it/manage/", "/elections/"), section="System"),
                _nav_item(label="Audit Logs", url="/audit/events/", request_path=request_path, matches=("/audit/events/",), section="System"),
                _nav_item(label="Account Security", url="/portal/account/security/", request_path=request_path, matches=("/portal/account/security/",), section="System"),
                _nav_item(label="Logout", url="/auth/logout/", request_path=request_path, matches=("/auth/logout/",), section="System"),
            ]
    ...
    if portal_key == "dean":
        items.extend(
            [
                ...
                _nav_item(
                    label="Term Review",
                    url="/results/dean/term-review/",
                    request_path=request_path,
                    matches=("/results/dean/term-review/",),
                    section="Review",
                ),
                _nav_item(
    ...
    if portal_key == "hostel":
        items.extend(
            [
                _nav_item(label="Dashboard", url="/", request_path=request_path, matches=("/", "/portal/hostel/$"), section="Main"),
                _nav_item(
                    label="Hostel Comments",
                    url="/results/hostel/",
                    request_path=request_path,
                    matches=("/results/hostel/",),
                    section="Hostel",
                ),
                _nav_item(
                    label="Profile",
    ...
    if portal_key == "student":
        if cloud_student_portal_limited_enabled():
            ...
            if not cloud_student_finance_disabled():
                items.insert(
                    -1,
                    _nav_item(
                        label="Finance",
    ...
    if portal_key == "cbt":
        if ROLE_STUDENT in role_codes:
            ...
            if role_codes & {ROLE_SUBJECT_TEACHER, ROLE_FORM_TEACHER, ROLE_DEAN, ROLE_IT_MANAGER}:
                items.append(
                    _nav_item(
                        label="CBT Authoring",
                        url="/cbt/authoring/",
            ...
            if role_codes & {ROLE_DEAN, ROLE_IT_MANAGER}:
                items.append(
                    _nav_item(
