...
def build_student_academic_analytics(*, student, current_session=None, current_term=None):
    ...
    for compilation in compilations:
        ...
        fail_count = len([row for row in score_rows if is_failing_grade(row.grade)])
        row_payload = {
...
def build_teacher_performance_analytics(*, teacher, current_session=None, current_term=None):
    ...
    if current_term:
        ...
        assignment_qs = exclude_external_exam_classes_for_term(
            assignment_qs,
            current_term,
    ...
    if current_term:
        ...
        exam_qs = exclude_external_exam_classes_for_term(
            exam_qs,
            current_term,
            field_name="academic_class",
        )
