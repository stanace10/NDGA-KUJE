...
class SchoolProfile(TimeStampedModel):
    ...
    assignment_label = models.CharField(max_length=40, default="Assignment / Projects / Practical")
    ...
    def clean(self):
        ...
        self.assignment_label = (self.assignment_label or "Assignment / Projects / Practical").strip()
...
class PublicWebsiteSettings(TimeStampedModel):
    singleton_key = models.CharField(max_length=16, default="PRIMARY", unique=True, editable=False)
    hero_eyebrow = models.CharField(max_length=160, default="Welcome to Notre Dame Girls' Academy, Kuje Abuja")
    ...
    chat_welcome_text = models.TextField(
        default=(
            "Hello. I am Smart NDGA. I can guide you on admissions, boarding, "
            "subjects, screening, school life, and contact details."
        )
    )
...
class PublicSiteSubmission(TimeStampedModel):
    ...
    application_fee_receipt = models.FileField(
    ...
    def public_admission_pdf_available(self):
        return (
            ...
            and bool(self.application_fee_receipt)
        )
...
class PublicEventImage(TimeStampedModel):
    ...
    def __str__(self):
        return self.title or f"{self.event.title} image"
