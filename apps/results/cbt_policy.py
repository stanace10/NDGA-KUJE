...
DEFAULT_RESULT_CBT_POLICIES = {
    ...
    "exam": {"enabled": False, "objective_max": "20.00", "theory_max": "30.00"},
}
...
def normalize_result_cbt_policies(raw):
    ...
    policies["ca4"]["enabled"] = False
    policies["ca4"]["objective_max"] = DEFAULT_RESULT_CBT_POLICIES["ca4"]["objective_max"]
    policies["ca4"]["theory_max"] = DEFAULT_RESULT_CBT_POLICIES["ca4"]["theory_max"]
    return policies
