...
urlpatterns = [
    ...
    path(
        "cbt/microphone/permission/",
        CBTMicrophonePermissionView.as_view(),
        name="cbt-microphone-permission",
    ),
    ...
    path(
        "it/student/<int:user_id>/change-password/",
        ITStudentPasswordResetView.as_view(),
        name="it-student-password-reset",
    ),
    path(
