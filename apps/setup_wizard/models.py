...
class AcademicOperationWindow(TimeStampedModel):
    class WindowType(models.TextChoices):
        RESULTS = "RESULTS", "Result Window"
        RESULT_CA1 = "RESULT_CA1", "CA1 Result Window"
        RESULT_CA23 = "RESULT_CA23", "CA2/CA3 Result Window"
        RESULT_CA4 = "RESULT_CA4", "Assignment / Projects / Practical Result Window"
        RESULT_EXAM = "RESULT_EXAM", "Exam Result Window"
        CBT = "CBT", "CBT Window"

    window_type = models.CharField(max_length=16, choices=WindowType.choices, unique=True)
    ...
    def __str__(self):
        return self.get_window_type_display()
