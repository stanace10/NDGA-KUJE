...
class PaymentForm(_StyledFormMixin, forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["payment_method"].choices = [
            (PaymentMethod.PIXPAY, "PixPay"),
            (PaymentMethod.TRANSFER, "Bank Transfer"),
            (PaymentMethod.CASH, "Cash"),
            (PaymentMethod.POS, "POS"),
            (PaymentMethod.OTHER, "Other"),
        ]
        self.fields["payment_method"].initial = PaymentMethod.PIXPAY
        self.fields["gateway_reference"].label = "PixPay / Receipt Reference"
        self.fields["gateway_reference"].help_text = "Enter the PixPay transaction reference or receipt number."
...
class GatewayPaymentInitForm(_StyledFormMixin, forms.Form):
    ...
    def clean_fee_item(self):
        return (self.cleaned_data.get("fee_item") or "").strip()
