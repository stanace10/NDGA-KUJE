...
from apps.pdfs.views import (
    PDFVerificationView,
    StaffCumulativeReportDownloadView,
    ...
    StudentCumulativeReportDownloadView,
    StudentReportsView,
...
urlpatterns = [
    ...
    path(
        "student/reports/<int:compilation_id>/cumulative/download/",
        StudentCumulativeReportDownloadView.as_view(),
        name="student-cumulative-report-download",
    ),
    path(
    ...
    path(
        "staff/reports/<int:compilation_id>/student/<int:student_id>/cumulative/download/",
        StaffCumulativeReportDownloadView.as_view(),
        name="staff-cumulative-report-download",
    ),
    path(
